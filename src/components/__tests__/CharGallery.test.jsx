...
test('should render all cards', () => {
    ...
    render(<CharGallery charsData={charsData} />)
    const charGalleryElement = screen.getByTestId(`CharGallery_1`);
    charsData.forEach(c => {
        const charCard = screen.getByTestId(`CharCard-${c.char_id}`)
        expect(charGalleryElement).toContainElement(charCard)
    })
})
